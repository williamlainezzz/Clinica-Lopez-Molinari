...
return new class extends Migration
{
    ...
    {
        // En PRODUCCIÓN: no tocar la función (evita error de privilegios en el deploy)
        if (app()->environment('production')) {
            return;
        }

        // En entornos no-productivos sí la creamos/actualizamos
        try {
            DB::unprepared(<<<'SQL'
...
SQL);
            ...
            // si algo pasa en dev/local, no tumbes la migración
        }
    }
