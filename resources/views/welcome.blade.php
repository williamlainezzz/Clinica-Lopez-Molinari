...
<head>
    ...
    {{-- Estilos para inputs dentro de los modales --}}
...
<body class="min-h-screen bg-gradient-to-br from-sky-50 via-white to-teal-50 text-slate-800 relative">
    ...
    <header class="mx-auto max-w-6xl px-6 py-5">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="flex h-11 w-11 items-center justify-center rounded-full bg-sky-900 shadow-sm ring-2 ring-white/70">
                    <img src="{{ asset('images/logo_clinica.avif') }}"
                         alt="Logo Complejo Dental López Molinari"
                         class="h-8 w-8 object-contain">
                </div>
                <div>
                    <p class="text-lg sm:text-xl font-semibold tracking-tight text-slate-900">
                        Complejo Dental <span class="text-slate-800">López Molinari</span>
                    </p>
            ...
            {{-- Sin botones arriba, como acordamos --}}
            <div></div>
        </div>
    </header>

    {{-- HERO / PORTADA --}}
    <main class="mx-auto max-w-6xl px-6 pt-4 pb-10 lg:pb-14">
        <div class="grid items-center gap-10 lg:grid-cols-2">
            ...
            <section>
                ...
                <p class="mt-6 text-base sm:text-lg text-slate-700 max-w-xl">
                    Administra citas, pacientes y agenda del
                    <span class="font-semibold">Complejo Dental López Molinari</span>
                    desde un solo lugar. Accede como paciente o como doctor de forma segura.
                </p>

                <div class="mt-8 flex flex-wrap gap-3">
                    {{-- Estos botones abren los modales por eventos globales --}}
                    <button
                        type="button"
                        data-open="login"
                        class="inline-flex items-center justify-center rounded-xl bg-sky-700 px-6 py-3 text-white shadow-sm ring-1 ring-sky-700/10 hover:bg-sky-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-700">
                        Iniciar sesión
                    </button>
                ...
                <ul class="mt-8 space-y-2 text-sm sm:text-base text-slate-700">
                    <li class="flex gap-2">
                        <span class="mt-2 h-1.5 w-1.5 rounded-full bg-sky-600"></span>
            ...
            <section aria-label="Sede principal del Complejo Dental López Molinari" class="relative">
                <div class="relative overflow-hidden rounded-3xl bg-white/80 shadow-lg ring-1 ring-slate-200">
                    <img
                        src="{{ asset('images/clinica_exterior.avif') }}"
                        alt="Fachada del Complejo Dental López Molinari — Tegucigalpa, Honduras."
                        class="h-[320px] w-full object-cover sm:h-[360px] lg:h-[400px]">
                    <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-900/85 via-slate-900/40 to-transparent px-6 py-4 text-xs sm:text-sm text-slate-50">
                        <p class="font-semibold tracking-wide">Sede principal</p>
                        <p class="mt-0.5">
    ...
    >
        ...
        {{-- ===== MODAL LOGIN (diseño nuevo + lógica original) ===== --}}
        <div x-cloak x-show="showLogin" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div x-transition
                 class="modal-panel relative w-full max-w-lg mx-4 rounded-[2rem] bg-white shadow-2xl ring-1 ring-slate-200 overflow-hidden">
                {{-- Header gradiente --}}
                <div class="relative bg-gradient-to-r from-sky-500 via-sky-600 to-blue-700 px-6 py-5 text-white">
                    <p class="text-[11px] font-semibold tracking-[0.25em] uppercase">
                        Bienvenido
                    </p>
                    ...
                    <button
                        class="absolute right-4 top-4 rounded-full bg-white/10 p-1.5 text-white hover:bg-white/20"
                ...
                <div class="p-6 max-h-[80vh] overflow-y-auto">
                    @if ($errors->login->any())
                        <div class="mb-3 text-sm text-red-600">
                            No pudimos iniciar sesión con los datos ingresados. Verifica tu usuario o correo y tu
                            contraseña e inténtalo nuevamente.
                        </div>
                    @endif
        ...
        {{-- ===== MODAL REGISTRO (diseño nuevo + lógica original) ===== --}}
        <div x-cloak x-show="showRegister" x-transition.opacity class="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div x-transition
                 class="modal-panel relative w-full max-w-5xl mx-4 rounded-[2rem] bg-white shadow-2xl ring-1 ring-slate-200 overflow-hidden">
                {{-- Header gradiente --}}
                <div class="relative bg-gradient-to-r from-sky-500 via-sky-600 to-blue-700 px-6 py-5 text-white">
                    <p class="text-[11px] font-semibold tracking-[0.25em] uppercase">
                ...
                <div class="p-6 max-h-[85vh] overflow-y-auto">
                    ...
                    <form method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        {{-- Header pequeño con username (igual que antes) --}}
    ...
    {{-- Delegación: abre modales usando data-open="login|register" --}}
    <script>
