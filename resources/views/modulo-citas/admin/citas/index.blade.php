                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="btn-group btn-group-sm mt-3 mt-md-0">
                            <button class="btn btn-outline-primary"><i class="fas fa-eye"></i> Ver</button>
                            <button class="btn btn-outline-success"><i class="fas fa-edit"></i> Editar</button>
                            <button class="btn btn-outline-warning"><i class="fas fa-sync"></i> Reprogramar</button>
                    ...
                    @foreach($availablePatients as $patient)
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <p class="text-muted mb-0 small">{{ $patient['motivo'] }} · Preferencia: {{ $patient['preferencia'] }}</p>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3">
                            <i class="fas fa-check-circle text-success mr-2"></i> Confirmar citas de mañana
                        </li>
                        <li class="mb-3">
                            <i class="fas fa-envelope text-primary mr-2"></i> Enviar recordatorios SMS
                        </li>
                        <li>
                            <i class="fas fa-file-medical text-info mr-2"></i> Revisar solicitudes de nuevos pacientes
                        </li>
                    </ul>
                </div>
            </div>
