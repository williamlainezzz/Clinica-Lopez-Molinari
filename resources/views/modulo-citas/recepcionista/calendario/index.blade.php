        ...
        <div class="col-lg-8 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    <div>
                        <h3 class="h5 mb-0">Agenda consolidada</h3>
                        <small class="text-muted">Click sobre un evento para detallar</small>
                    </div>
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary btn-block mb-2">Registrar nueva cita</button>
                    <button class="btn btn-outline-secondary btn-block">Enviar recordatorios</button>
                </div>
            </div>
        </div>
    </div>
