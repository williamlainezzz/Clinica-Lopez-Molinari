                ...
                <div class="container">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            ...
                            <p>
                                Tu sesión de seguridad expiró. Esto puede ocurrir si pasaste mucho tiempo en una pantalla
                                o si el token del formulario ya no es válido.
                            </p>
                            <p>
                                Vuelve a intentar la acción desde la pantalla anterior. Si el problema continúa, inicia sesión nuevamente.
                            </p>

                            <div class="mt-3">
                                <a href="{{ url()->previous() }}" class="btn btn-outline-primary mr-2">Volver e intentar de nuevo</a>
    ...
    <main class="mx-auto max-w-2xl px-6 py-20">
        <div class="rounded-2xl bg-white/80 shadow-sm ring-1 ring-slate-200 p-8 text-center">
            ...
            <p class="mt-2 text-slate-600">
                Tu sesión de seguridad expiró. Si estabas enviando un formulario, vuelve a abrirlo e inténtalo nuevamente.
            </p>
