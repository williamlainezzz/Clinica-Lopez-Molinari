...
<body class="@auth hold-transition layout-top-nav @else min-h-screen bg-gradient-to-br from-rose-50 via-white to-orange-50 text-slate-800 @endauth">
                ...
                <div class="container">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            ...
                            <p>
                                Ocurrió un problema inesperado. Puede ser temporal. Intenta nuevamente en unos minutos.
                            </p>
                            <p>
                                Si el problema persiste, comunícate con el administrador del sistema.
                            </p>

                            <div class="mt-3">
                                <a href="{{ url()->previous() }}" class="btn btn-outline-secondary mr-2">Volver</a>
    ...
    <main class="mx-auto max-w-2xl px-6 py-20">
        <div class="rounded-2xl bg-white/80 shadow-sm ring-1 ring-slate-200 p-8 text-center">
            ...
            <p class="mt-2 text-slate-600">
                Estamos presentando un inconveniente temporal. Por favor, inténtalo nuevamente en unos minutos.
            </p>
